    ...
    <div className="mx-auto container max-w-[1440px] flex flex-col md:flex-row justify-between mt-[100px] border-b border-[#CBCBCB] pb-[30px] xl:px-10 md:px-6 px-4">
      <div className="max-w-full md:max-w-[50%] relative">
        ...
        <div className="flex flex-col w-full space-y-3 xl:space-y-6 justify-between items-start ">
          <div className="card1 bg-white px-[18px] mt-6 card-shadow rounded-xl flex justify-between items-end py-[10px] min-w-[245px] xl:min-w-[345px]">
          ...
          <div className="card2 bg-white px-[18px] rounded-xl flex justify-between items-end py-[10px] min-w-[250px] xl:min-w-[345px]">
            <div className="flex justify-between items-center">
              <div className="items-end flex">
                <img src="/assets/images/FoodPurchase.png" />
              </div>
          ...
          <div className="card3 bg-white px-[18px] rounded-xl flex justify-between items-end py-[10px] min-w-[245px] xl:min-w-[345px]">
            <div className="flex justify-between items-center">
              <div className="items-end flex">
                <img src="/assets/images/FoodPurchase.png" />
              </div>
        ...
        <div>
          <svg
            ...
            className="absolute top-[350px] right-10 md:hidden"
          >
            <path
      ...
      <div className="max-w-full pt-[100px] md:max-w-[50%] w-full">
        <img
          src="/assets/images/bg-purchase.png"
          className="max-w-[360px] min-h-[338px] md:max-w-[385px] md:min-h-[500px]"
        />
      </div>
    </div>
  );
