...
const Footer = () => {
  return (
    <div className="bg-[#EAEAEA]">
      <div className="mx-auto container max-w-[1440px] border-b border-[#CBCBCB] mt-[95px] md:mt-[216px] pb-[30px] xl:px-10 md:px-6 px-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="left max-w-full md:max-w-[60%] w-full">
          ...
          <div className="right footer-menu max-w-full md:max-w-[40%] w-full">
            <ul className="font-inter space-y-[30px] md:space-y-0 font-medium text-lg leading-[26px] text-[#999999] w-full flex flex-col md:flex-row justify-between items-start md:items-center max-w-[90%]">
              <li>
                <a>Blog</a>
              </li>
              <li>
      ...
      <div className="hidden md:block mx-auto container max-w-[1440px] mt-[57px] pb-20 px-[40px]">
        <div className="flex justify-between items-center ">
          ...
          <div className="max-w-[30%] w-full flex justify-end">
            <div className="Social-Buttons flex justify-around items-center w-full">
              <a>
                <svg
                  width={22}
                  height={22}
      ...
      <div className="flex md:hidden relative">
        <div className="absolute top-[-305px] right-2 Social-Buttons flex justify-around items-center w-[42%]">
          <a>
            <svg
              width={22}
              height={22}
      ...
      <div className="flex md:hidden border-t border-[#CBCBCB] pt-[26px] pb-[36px] w-full justify-center">
        <p className="font-inter font-medium text-[13px] leading-[19.91px] text-[#70798B]">© 2023 GoGrocer All Rights Reserved.</p>
      </div>
    </div>
  );
};
